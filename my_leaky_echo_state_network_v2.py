...
class Leaky_echo_state_network:
    ...
    def change_step(self, step_num):
        self.predict_data_changed = self.output_data[step_num:]
        self.test_time_data_changed = self.test_time_data[:-step_num]
        ...
        if self.predict_data_changed is not None:
            __graph(self.test_time_data_changed, self.predict_data_changed, "predict_changed", 'yellow')
